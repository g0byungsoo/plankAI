...
generate_routine_clips() {
    ...
    case "$P" in
        jeni_)
            ...
            generate $V "${P}duration_intro_5" "Just five minutes today. Make them count, whenever you're ready."
            generate $V "${P}duration_intro_10" "About ten minutes today. A solid, steady session, whenever you're ready."
            generate $V "${P}duration_intro_15" "Around fifteen minutes today. Settle in and we'll move together, whenever you're ready."
            generate $V "${P}duration_intro_20" "About twenty minutes today. Strong, intentional, mindful, whenever you're ready."
        ...
        matson_)
            ...
            generate $V "${P}duration_intro_5" "Quick five-minute one. Make it count, whenever you're ready."
            generate $V "${P}duration_intro_10" "About ten minutes today. Solid session ahead, whenever you're ready."
            generate $V "${P}duration_intro_15" "Around fifteen minutes today. Pace yourself, whenever you're ready."
            generate $V "${P}duration_intro_20" "Twenty minutes today. Long but doable, whenever you're ready."
        ...
        *)
            ...
            generate $V "duration_intro_5" "Five minutes. No excuses, whenever you're ready."
            generate $V "duration_intro_10" "Ten minutes today. Lock in, whenever you're ready."
            generate $V "duration_intro_15" "Fifteen minutes. Deep work, whenever you're ready."
            generate $V "duration_intro_20" "Twenty minutes. Earn it, whenever you're ready."
