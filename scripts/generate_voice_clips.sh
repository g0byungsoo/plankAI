...
generate_routine_clips() {
    ...
    case "$P" in
        jeni_)
            ...
            generate $V "${P}focus_intro_flatBelly" "Welcome. Today is about your core. Building real stability — better posture, deeper breath, more support for everything you do."
            generate $V "${P}focus_intro_roundButt" "Welcome. Today we wake up your glutes. Strong hips help your back, your knees, your everyday movement. Move with intention."
            generate $V "${P}focus_intro_slimLegs" "Welcome. Today we focus on your legs. Strong legs are your foundation — for running, for stairs, for standing tall in your body."
            generate $V "${P}focus_intro_tonedArms" "Welcome. Today we work your arms and shoulders. Posture, lifting power, everyday confidence — all come from this."
            generate $V "${P}focus_intro_fullBody" "Welcome. Today is a full-body session. Strength, balance, breath — keeping your whole system tuned and steady."
        ...
        matson_)
            ...
            generate $V "${P}focus_intro_flatBelly" "Alright, glad you're here. Today's all about the core. Builds real stability — better posture, less back pain, stronger everything."
            generate $V "${P}focus_intro_roundButt" "Hey, let's do this. Glute day. Stronger hips support your back, your knees, all of it. Squeeze every rep."
            generate $V "${P}focus_intro_slimLegs" "What's up. Legs today. Strong legs make daily life easier — running, stairs, you name it. Push through it."
            generate $V "${P}focus_intro_tonedArms" "Alright, arms and shoulders today. Build that pulling power, fix your posture, stay strong. Solid form."
            generate $V "${P}focus_intro_fullBody" "Hey, glad you showed up. Full-body day — strength, balance, conditioning all in one. Stay loose, keep moving."
        ...
        *)
            ...
            generate $V "focus_intro_flatBelly" "Time to work that core. Stronger core means better posture, less back pain, stronger everything. Lock in."
            generate $V "focus_intro_roundButt" "Glute day. Stronger hips support your back and knees, plus you wanted the peach. Squeeze every rep."
            generate $V "focus_intro_slimLegs" "Legs today. Strong legs make life easier — running, stairs, standing through long shifts. Push through."
            generate $V "focus_intro_tonedArms" "Arms and shoulders. Strong upper body fixes your posture and your lifting. No swinging, just controlled work."
            generate $V "focus_intro_fullBody" "Full body today. Strength, balance, conditioning — everything in one session. Stay sharp."
