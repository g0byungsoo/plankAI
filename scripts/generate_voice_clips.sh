...
generate_routine_clips() {
    ...
    case "$P" in
        jeni_)
            ...
            # Focus-specific welcome — names the focus + the benefit
            # to the body. No "tap start" here; the chained
            # duration_intro carries the CTA.
            generate $V "${P}focus_intro_flatBelly" "Welcome. Today targets your core — your abs, obliques, and the deep stabilizers that hold your posture and support your breath. Built around recovery so you can come back stronger."
            generate $V "${P}focus_intro_roundButt" "Welcome. Today targets your glutes and hips — the muscles that power your stride, protect your knees, and support your lower back. Built around recovery so you can come back stronger."
            generate $V "${P}focus_intro_slimLegs" "Welcome. Today targets your legs — your quads, hamstrings, and calves. The muscles that support every step, every stair, every squat. Built around recovery so you can come back stronger."
            generate $V "${P}focus_intro_tonedArms" "Welcome. Today targets your arms and shoulders — your deltoids, biceps, and triceps. Builds the muscles for better posture and everyday confidence. Built around recovery so you can come back stronger."
            generate $V "${P}focus_intro_fullBody" "Welcome. Today is full-body — targeting your core, your glutes, your legs, and your shoulders. Balanced strength, balanced recovery, so you can come back stronger."
            # Duration intro — chained after focus_intro by PreRoutineView.
            # Mentions length + carries the "tap start" CTA.
            generate $V "${P}duration_intro_5" "Just five minutes today — quick, focused, intentional. We begin when you do."
            generate $V "${P}duration_intro_10" "About ten minutes today. A solid, steady session, we'll move together. We begin when you do."
            generate $V "${P}duration_intro_15" "Around fifteen minutes today. Settle in — we'll work through this with care. We begin when you do."
            generate $V "${P}duration_intro_20" "About twenty minutes today — strong, deliberate, mindful. We begin when you do."
        ...
        matson_)
            ...
            generate $V "${P}focus_intro_flatBelly" "Alright, glad you're here. Today's all about the core — abs, obliques, deep stabilizers. The muscles that hold your posture and protect your back. Built around recovery so you can keep coming back."
            generate $V "${P}focus_intro_roundButt" "Hey, let's do this. Glute day — glutes and hips, the muscles that power every step and protect your knees and back. Built around recovery so you come back fresh tomorrow."
            generate $V "${P}focus_intro_slimLegs" "What's up. Legs today — quads, hamstrings, calves. Strong legs power every step, every stair, every move. Built around recovery."
            generate $V "${P}focus_intro_tonedArms" "Alright, arms and shoulders today — deltoids, biceps, triceps. Builds posture, lifting power, everyday strength. Built around recovery."
            generate $V "${P}focus_intro_fullBody" "Hey, glad you showed up. Full-body today — core, glutes, legs, and shoulders all in one. Balanced work, built around recovery."
            generate $V "${P}duration_intro_5" "Quick five-minute one. We'll keep it tight and get it done. Let's roll when you do."
            generate $V "${P}duration_intro_10" "About ten minutes today. Solid session, we'll pace it right. Let's roll when you do."
            generate $V "${P}duration_intro_15" "Around fifteen minutes today. We'll find the rhythm and stay with it. Let's roll when you do."
            generate $V "${P}duration_intro_20" "Twenty minutes today. Long one — but we'll get there together. Let's roll when you do."
        ...
        *)
            ...
            generate $V "focus_intro_flatBelly" "Time to work the core — abs, obliques, deep stabilizers. The muscles that hold your posture and protect your back. Built around recovery."
            generate $V "focus_intro_roundButt" "Glute day — glutes and hips. The muscles that power your stride and protect your back and knees. Built around recovery so you keep showing up."
            generate $V "focus_intro_slimLegs" "Legs today — quads, hamstrings, calves. Strong legs make daily life easier. Built around recovery so you can keep training."
            generate $V "focus_intro_tonedArms" "Arms and shoulders — deltoids, biceps, triceps. Strong upper body fixes your posture and your lifting. Built around recovery."
            generate $V "focus_intro_fullBody" "Full body today — core, glutes, legs, shoulders. Strength, balance, conditioning. Built around recovery."
            generate $V "duration_intro_5" "Five minutes. No excuses, no shortcuts. We start when you do."
            generate $V "duration_intro_10" "Ten minutes today. Lock in and stay locked in. We start when you do."
            generate $V "duration_intro_15" "Fifteen minutes — deep work. Stay sharp, stay honest. We start when you do."
            generate $V "duration_intro_20" "Twenty minutes. Earn it through every rep. We start when you do."
