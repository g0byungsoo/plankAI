...
generate_routine_clips() {
    ...
    case "$P" in
        jeni_)
            ...
            generate $V "${P}duration_intro_5" "Just five minutes today. Make them count. Tap start when you're ready."
            generate $V "${P}duration_intro_10" "About ten minutes today. A solid, steady session. Tap start when you're ready."
            generate $V "${P}duration_intro_15" "Around fifteen minutes today. Settle in, we'll move together. Tap start when you're ready."
            generate $V "${P}duration_intro_20" "About twenty minutes today. Strong, intentional, mindful. Tap start when you're ready."
        ...
        matson_)
            ...
            generate $V "${P}duration_intro_5" "Quick five-minute one. Make it count. Tap start when you're ready."
            generate $V "${P}duration_intro_10" "About ten minutes today. Solid session ahead. Tap start when you're ready."
            generate $V "${P}duration_intro_15" "Around fifteen minutes today. Pace yourself. Tap start when you're ready."
            generate $V "${P}duration_intro_20" "Twenty minutes today. Long but doable. Tap start when you're ready."
        ...
        *)
            ...
            generate $V "duration_intro_5" "Five minutes. No excuses. Tap start when you're ready."
            generate $V "duration_intro_10" "Ten minutes today. Lock in. Tap start when you're ready."
            generate $V "duration_intro_15" "Fifteen minutes. Deep work. Tap start when you're ready."
            generate $V "duration_intro_20" "Twenty minutes. Earn it. Tap start when you're ready."
