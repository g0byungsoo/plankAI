...
generate_routine_clips() {
    ...
    case "$P" in
        jeni_)
            ...
            # Focus-specific welcome — includes a focus mention + tip.
            # PreRoutineView picks one based on user's bodyFocus, falls
            # back to routine_start_<n> if focus is unknown.
            generate $V "${P}focus_intro_flatBelly" "Welcome. Today is about your core. Slow, controlled, present. Let each movement come from your center, and keep your breath steady throughout. Tap start when you're ready."
            generate $V "${P}focus_intro_roundButt" "Welcome. Today we wake up your glutes. Move with intention, engage your core through every lift, and listen to your body. Tap start when you're ready."
            generate $V "${P}focus_intro_slimLegs" "Welcome. Today we focus on your legs. Strong, grounded, deliberate. Push from your heels, lift with care, and breathe through the effort. Tap start when you're ready."
            generate $V "${P}focus_intro_tonedArms" "Welcome. Today we work your arms and shoulders. Strong, but kind to yourself. Move with control, breathe through the effort, and stay present. Tap start when you're ready."
            generate $V "${P}focus_intro_fullBody" "Welcome. Today is a full-body session. Everything in balance, nothing rushed. Stay present with each transition, breathe through, and trust the work. Tap start when you're ready."
        ...
        matson_)
            ...
            generate $V "${P}focus_intro_flatBelly" "Alright, glad you showed up. Today's all about that core — slow burn, controlled reps, no rushing through anything. Lock in your breath, keep the rib cage down. Tap start when you're ready."
            generate $V "${P}focus_intro_roundButt" "Hey, let's do this. Today's a glute day — squeeze with every rep, keep that core tight, and don't rush the bottom of the move. You'll feel it tomorrow. Tap start when you're ready."
            generate $V "${P}focus_intro_slimLegs" "What's up. Today we hit the legs. Strong stance, drive from the heels, full range — no half reps cheating. You've got this. Tap start when you're ready."
            generate $V "${P}focus_intro_tonedArms" "Alright, today's arms and shoulders. Solid form, no swinging or momentum. Keep it controlled, breathe through the burn. Tap start when you're ready."
            generate $V "${P}focus_intro_fullBody" "Hey, glad you're here. Full-body today — quick transitions, stay loose, keep that breath steady. We'll move together. Tap start when you're ready."
        ...
        *)
            ...
            generate $V "focus_intro_flatBelly" "Alright, time to work that core. No phoning it in — your abs know if you're cheating. Lock in, breathe, keep the rib cage down. Tap start when you're ready."
            generate $V "focus_intro_roundButt" "Glute day. You wanted a peach, this is how you earn it. Squeeze every rep, keep your core tight, don't rush. Tap start when you're ready."
            generate $V "focus_intro_slimLegs" "Legs today. No skipping the burn — that's where the change happens. Push from the heels, full range, full effort. Tap start when you're ready."
            generate $V "focus_intro_tonedArms" "Arms and shoulders. Strong, controlled, no momentum cheating. I'm watching. Tap start when you're ready."
            generate $V "focus_intro_fullBody" "Full body today. No coasting through any single move. Stay sharp, stay honest, breathe through. Tap start when you're ready."
