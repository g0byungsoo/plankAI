...
// p54 — the PillarId → archetype affinity map died with its only
// consumers (the CBT scheduler and the lesson reader's folio, both
// deleted with the corpus). PillarId itself was defined in the
// deleted manifest types.
