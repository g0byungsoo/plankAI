...
//
// `scrapbookCard` — accent-border + hard-offset shadow. Reads as
// JeniFit-coquette playful. Welcome screen, plan-reveal hero,
// celebration peaks. The brand-warmth surfaces. Settings retired its
// sibling `editorialCard` in the v1.1 clean-luxury pass — list-like
// surfaces use SettingsChrome hairline sections instead of cards.
